...
ggplot(hatchery_baseflow) +
  ...
  labs(fill = "Flow Type")
```
As we can see, the difference between the baseflow and overall discharge for Hatchery Creek is much less than the difference in baseflow and overall discharge for Staney Creek.
