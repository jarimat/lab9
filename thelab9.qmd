...
ggplot(staney_baseflow) +
  ...
  labs(fill = "Flow Type")
```
**Figure 5.** Above is a plot of the flow type for Staney Creek, showing only data from 2022 for clarity.
...
ggplot(hatchery_baseflow) +
  ...
  labs(fill = "Flow Type")
```
**Figure 7.** Above is a plot of the flow type for Hatchery Creek, showing only data from 2022 for clarity.
